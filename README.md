## rc_genicam_api (lyrical) - 2.8.6-1

The packages in the `rc_genicam_api` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro lyrical` on `Wed, 03 Jun 2026 07:17:03 -0000`
...
## rc_genicam_api (rolling) - 2.8.6-1

The packages in the `rc_genicam_api` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro rolling` on `Wed, 03 Jun 2026 06:36:17 -0000`
...
## rc_genicam_api (lyrical) - 2.8.5-1

The packages in the `rc_genicam_api` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro lyrical` on `Tue, 02 Jun 2026 20:22:57 -0000`
...
## rc_genicam_api (rolling) - 2.8.5-1

The packages in the `rc_genicam_api` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro rolling` on `Tue, 02 Jun 2026 20:04:32 -0000`
...
## rc_genicam_api (kilted) - 2.8.1-1

The packages in the `rc_genicam_api` repository were released into the `kilted` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro kilted` on `Thu, 31 Jul 2025 08:42:26 -0000`
...
## rc_genicam_api (rolling) - 2.8.1-1

The packages in the `rc_genicam_api` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro rolling` on `Thu, 31 Jul 2025 08:25:22 -0000`
...
## rc_genicam_api (jazzy) - 2.8.1-1

The packages in the `rc_genicam_api` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro jazzy` on `Thu, 31 Jul 2025 08:09:55 -0000`
...
## rc_genicam_api (rolling) - 2.6.5-1

The packages in the `rc_genicam_api` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro rolling` on `Tue, 12 Mar 2024 14:40:15 -0000`
...
## rc_genicam_api (rolling) - 2.6.1-1

The packages in the `rc_genicam_api` repository were released into the `rolling` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro rolling -e` on `Fri, 10 Mar 2023 19:16:41 -0000`
...
- upstream repository: https://github.com/roboception/rc_genicam_api.git
- release repository: https://github.com/ros2-gbp/rc_genicam_api-release.git
- rosdistro version: `2.5.12-2`
- old version: `2.5.12-2`
- new version: `2.6.1-1`
...
## rc_genicam_api (humble) - 2.6.1-1

The packages in the `rc_genicam_api` repository were released into the `humble` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro humble -e` on `Fri, 10 Mar 2023 19:09:58 -0000`
...
- upstream repository: https://github.com/roboception/rc_genicam_api.git
- release repository: https://github.com/ros2-gbp/rc_genicam_api-release.git
- rosdistro version: `2.5.12-3`
- old version: `2.5.12-3`
- new version: `2.6.1-1`
...
## rc_genicam_api (foxy) - 2.6.1-1

The packages in the `rc_genicam_api` repository were released into the `foxy` distro by running `/usr/bin/bloom-release rc_genicam_api --rosdistro foxy -e` on `Fri, 10 Mar 2023 19:04:45 -0000`
...
- upstream repository: https://github.com/roboception/rc_genicam_api.git
- release repository: https://github.com/ros2-gbp/rc_genicam_api-release.git
- rosdistro version: `2.5.12-1`
- old version: `2.5.12-1`
- new version: `2.6.1-1`
...
## rc_genicam_api (rolling) - 2.5.12-1

The packages in the `rc_genicam_api` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling rc_genicam_api --override-release-repository-url https://github.com/ros2-gbp/rc_genicam_api-release.git --override-release-repository-push-url git@github.com:ros2-gbp/rc_genicam_api-release.git` on `Tue, 16 Nov 2021 11:56:44 -0000`
...
## rc_genicam_api (galactic) - 2.5.12-1

The packages in the `rc_genicam_api` repository were released into the `galactic` distro by running `/usr/bin/bloom-release --ros-distro galactic rc_genicam_api --override-release-repository-url https://github.com/ros2-gbp/rc_genicam_api-release.git --override-release-repository-push-url git@github.com:ros2-gbp/rc_genicam_api-release.git` on `Tue, 16 Nov 2021 11:54:20 -0000`
...
## rc_genicam_api (rolling) - 2.5.0-1

The packages in the `rc_genicam_api` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling rc_genicam_api` on `Thu, 04 Mar 2021 14:52:15 -0000`
...
## rc_genicam_api (foxy) - 2.5.0-1

The packages in the `rc_genicam_api` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --ros-distro foxy rc_genicam_api` on `Thu, 04 Mar 2021 14:48:10 -0000`
...
## rc_genicam_api (noetic) - 2.5.0-1

The packages in the `rc_genicam_api` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rc_genicam_api` on `Thu, 04 Mar 2021 14:44:25 -0000`
...
## rc_genicam_api (melodic) - 2.5.0-1

The packages in the `rc_genicam_api` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic rc_genicam_api` on `Thu, 04 Mar 2021 14:34:38 -0000`
...
## rc_genicam_api (rolling) - 2.4.4-1

The packages in the `rc_genicam_api` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling rc_genicam_api` on `Thu, 14 Jan 2021 10:00:17 -0000`
...
## rc_genicam_api (foxy) - 2.4.4-1

The packages in the `rc_genicam_api` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --ros-distro foxy rc_genicam_api` on `Tue, 27 Oct 2020 18:27:20 -0000`
...
## rc_genicam_api (eloquent) - 2.4.4-1

The packages in the `rc_genicam_api` repository were released into the `eloquent` distro by running `/usr/bin/bloom-release --ros-distro eloquent rc_genicam_api` on `Tue, 27 Oct 2020 18:22:57 -0000`
...
## rc_genicam_api (dashing) - 2.4.4-1

The packages in the `rc_genicam_api` repository were released into the `dashing` distro by running `/usr/bin/bloom-release --ros-distro dashing rc_genicam_api` on `Tue, 27 Oct 2020 14:14:06 -0000`
...
## rc_genicam_api (noetic) - 2.4.4-1

The packages in the `rc_genicam_api` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rc_genicam_api` on `Tue, 27 Oct 2020 13:57:47 -0000`
...
## rc_genicam_api (melodic) - 2.4.4-1

The packages in the `rc_genicam_api` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic rc_genicam_api` on `Tue, 27 Oct 2020 11:51:28 -0000`
...
## rc_genicam_api (kinetic) - 2.4.4-1

The packages in the `rc_genicam_api` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro kinetic rc_genicam_api` on `Tue, 27 Oct 2020 09:50:17 -0000`
...
## rc_genicam_api (eloquent) - 2.4.1-2

The packages in the `rc_genicam_api` repository were released into the `eloquent` distro by running `/usr/bin/bloom-release --ros-distro eloquent rc_genicam_api` on `Wed, 23 Sep 2020 12:56:25 -0000`
...
## rc_genicam_api (eloquent) - 2.4.1-1
...
The packages in the `rc_genicam_api` repository were released into the `dashing` distro by running `/usr/bin/bloom-release --ros-distro dashing --new-track rc_genicam_api` on `Mon, 06 Apr 2020 20:01:32 -0000`
...
## rc_genicam_api (melodic) - 1.3.6-0
